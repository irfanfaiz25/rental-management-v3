<div>
    <div class="block md:flex justify-start z-50 mt-3 space-y-1 md:space-y-0 md:space-x-2">
        <div
            class="bg-white dark:bg-[#252525] drop-shadow-sm py-3 px-3 w-full rounded-md border-2 border-gray-200/80 dark:border-[#2d2d2d]">
        ...
        <div
            class="w-full md:w-1/2 flex items-center bg-white dark:bg-[#252525] drop-shadow-sm py-3 px-3 rounded-md border-2 border-gray-200/80 dark:border-[#2d2d2d] space-x-1">
            <div class="flex items-center space-x-2">
        ...
        <div
            class="w-full md:w-1/5 flex justify-center items-center bg-white dark:bg-[#252525] drop-shadow-sm py-3 px-3 rounded-md border-2 border-gray-200/80 dark:border-[#2d2d2d] space-x-1">
    ...
    <div class="mt-3">
        {{ $rentals->links('vendor.livewire.tailwind') }}
    </div>
</div>
